...
<!doctype html>
<!--edit-customer-pw.php file for Jon's Snow Removal Page-->
<html lang="en">
...
<body>
    ...
    <main>
        ...
        <!--Sign up form-->
        <form action="update-customer-pw.php" method="post" style="border:1px solid #ccc">
            ...
            <div class="container">
                ...
                <div class="clearfix">
                    ...
                    <button type="submit" name="update-customer-pw" class="signupbtn">Update</button>
                </div>  
